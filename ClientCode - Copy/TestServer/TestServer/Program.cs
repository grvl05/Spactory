...
namespace TestServer
{
    class Program
    {
        ...
        private void GetFiles() //need to create a function to receive files(use the code below) and call the function everytime when files arrives
        {
        ...
        class TCPfile //maybe need to remove the "class" at TCPfile an Sockethandler
        {
            ...
            public TCPfile()
            {
                obj_server = new TcpListener(IPAddress.Any, FTPort);
            }
